...
public class DescriptionStarship extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ctx = this;
        starWarsAPI.getStarship(url,ctx);
        ...
        textView_hyperdrive_rating = (TextView) findViewById(R.id.textView_hyperdrive_rating_value);
        textView_MGLT = (TextView) findViewById(R.id.textView_MGLT_value);
        textView_starship_class = (TextView) findViewById(R.id.textView_starship_class_value);
    ...
    private class WaitAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            try {
                ...
                textView_hyperdrive_rating.setText(jsonObject.getString("hyperdrive_rating"));
                textView_MGLT.setText(jsonObject.getString("MGLT"));
                textView_starship_class.setText(jsonObject.getString("starship_class"));
